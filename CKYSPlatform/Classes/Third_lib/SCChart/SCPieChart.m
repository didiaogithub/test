...
- (UILabel *)descriptionLabelForItemAtIndex:(NSUInteger)index{
    ...
    descriptionLabel.font = MAIN_SUBTITLE_FONT;
    NSString *titleValue;
    ...
    CGSize labelSize = [descriptionLabel.text sizeWithAttributes:@{NSFontAttributeName:MAIN_SUBTITLE_FONT}];
