//
//  CKNotificationCenterViewController.m
//  CKYSPlatform
//
...
@interface CKNotificationCenterViewController ()<ZJScrollPageViewDelegate, ZJScrollPageViewChildVcDelegate>
...
@implementation CKNotificationCenterViewController
...
-(void)initComponents{
    ...
    // 初始化
    _scrollPageView = [[ZJScrollPageView alloc] initWithFrame:CGRectMake(0, 65+NaviAddHeight, SCREEN_WIDTH, SCREEN_HEIGHT - 65 - BOTTOM_BAR_HEIGHT-NaviAddHeight) segmentStyle:_style titles:self.titleArray parentViewController:self delegate:self];
...
-(void)getNotReadData:(NSInteger)selectedIndex{
    ...
    if ([titleStr isEqualToString:KMsgType_System]){
...
//        sysMsgStr = @"0";
//    }
//    ZJTitleView *titleView1 = titleViews[0];
...
//        officialStr = @"0";
//    }
//    ZJTitleView *titleView2 = titleViews[1];
...
-(UIViewController<ZJScrollPageViewChildVcDelegate> *)childViewController:(UIViewController<ZJScrollPageViewChildVcDelegate> *)reuseViewController forIndex:(NSInteger)index {
    ...
    CKNotificationContentViewController *tableVc = [[CKNotificationContentViewController alloc] init];
